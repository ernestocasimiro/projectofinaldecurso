...
<head>
    ...
    <title>Visualizar professor - <?= htmlspecialchars($g['fname'] . ' ' . $g['lname']); ?></title>
    <style>
        /* Reset básico */
        * {
...
<div class="container">
    ...
    <div class="card">
        ...
        <div class="card-info">
            ...
            <div class="info-section">
                <h2>Especialização e Nível Acadêmico</h2>
                <div class="info-row"><div class="info-label">Especialização:</div><div class="info-value"><?= htmlspecialchars($g['especializacao']); ?></div></div>
            ...
            <a href="teacher.php" class="btn-back">← Voltar para Lista</a>
        </div>
    </div>
</div>
