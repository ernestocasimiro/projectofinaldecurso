...
<head>
    ...
    <title>Visualizar coordenador - <?= htmlspecialchars($g['fname'] . ' ' . $g['lname']); ?></title>
    <style>
        /* Reset básico */
        * {
    ...
    <div class="card">
        ...
        <div class="card-info">
            <div class="info-section">
                ...
                <div class="info-row"><div class="info-label">Gênero:</div><div class="info-value"><?= htmlspecialchars($g['genero']); ?></div></div>
            ...
            <div class="info-section">
                ...
                <div class="info-row"><div class="info-label">Área Coordenação:</div><div class="info-value"><?= htmlspecialchars($g['area_coordenacao']); ?></div></div>
                <div class="info-row"><div class="info-label">Nível Acadêmico:</div><div class="info-value"><?= htmlspecialchars($g['nivel_academico']); ?></div></div>
                <div class="info-row"><div class="info-label">Experiência:</div><div class="info-value"><?= htmlspecialchars($g['anos_experiencia']); ?></div></div>
            </div>

            <a href="coordinator.php" class="btn-back">← Voltar para Lista</a>
        </div>
    </div>
</div>
