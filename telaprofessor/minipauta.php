...
<<<<<<< HEAD
    <script>
        ...
        window.dashboardData = {
            classes: [
                {id: '9A', name: '9º Ano A', students: 28},
                {id: '8B', name: '8º Ano B', students: 25},
                {id: '10C', name: '10º Ano C', students: 30},
                {id: '7D', name: '7º Ano D', students: 22}
            ],
            students: [
                {
                    id: 1,
                    ...
                    attendance: 96,
                    grades: {
                        math: {av1: 15, av2: 14, av3: 17, average: 15.3},
                        portuguese: {av1: 12, av2: 13, av3: 14, average: 13.0},
                        history: {av1: 16, av2: 15, av3: 17, average: 16.0}
                    }
                },
                {
                    id: 2,
                    ...
                    attendance: 100,
                    grades: {
                        math: {av1: 18, av2: 17, av3: 19, average: 18.0},
                        portuguese: {av1: 19, av2: 18, av3: 20, average: 19.0},
                        history: {av1: 17, av2: 18, av3: 19, average: 18.0}
                    }
                },
                {
                    id: 3,
                    ...
                    attendance: 89,
                    grades: {
                        math: {av1: 12, av2: 13, av3: 14, average: 13.0},
                        portuguese: {av1: 10, av2: 11, av3: 12, average: 11.0},
                        history: {av1: 14, av2: 13, av3: 15, average: 14.0}
                    }
                }
            ],
            updateDynamicDates: function() {
                // Atualizar datas dinâmicas
                const dateElements = document.querySelectorAll('[data-dynamic="current-date"]');
                const now = new Date();
            ...
            loadCurrentUserData: function() {
                ...
                const userElements = document.querySelectorAll('[data-dynamic="user-name"]');
                userElements.forEach(el => {
                    el.textContent = '<?php echo htmlspecialchars($teacher['fname'] . ' ' . $teacher['lname']); ?>';
                });
            }
        };
...
<<<<<<< HEAD
            ...
            if (tableBody.rows.length === 0) {
                alert('Nenhum aluno encontrado para exibir. Por favor, selecione uma turma e disciplina válidas.');
                return;
            }
