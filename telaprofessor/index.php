            ...
            <div class="dashboard-content">
                <div class="welcome-section">
                    <div class="welcome-text">
                        <h1>Bem-vindo, Professor/a <span><?php echo htmlspecialchars($teacher['fname'] . ' ' . $teacher['lname']); ?></span>!</h1>
                            ...
                            <table class="students-table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>10ª Classe - A</td>
                                        <td>
                                            <span class="activity-badge success">Enviou tarefa</span>
                                            <span class="activity-date">14/04</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>11ª Classe - B</td>
                                        <td>
                                            <span class="activity-badge warning">Questionário</span>
                                            <span class="activity-date">13/04</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>9ª Classe - C</td>
                                        <td>
                                            <span class="activity-badge primary">Participação</span>
                                            <span class="activity-date">12/04</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>10ª Classe - A</td>
                                        <td>
                                            <span class="activity-badge primary">Atividade</span>
                                            <span class="activity-date">11/04</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>11ª Classe - B</td>
                                        <td>
                                            <span class="activity-badge info">Presença</span>
                                            <span class="activity-date">10/04</span>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
